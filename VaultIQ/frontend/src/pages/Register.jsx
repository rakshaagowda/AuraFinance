...
import { Lock, UserPlus, AlertCircle, User } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] flex items-center justify-center relative p-6 overflow-hidden">
      ...
      <div className="absolute w-[500px] h-[500px] rounded-full bg-purple-500/10 blur-[120px] top-[10%] left-[20%] pointer-events-none" />
      <div className="absolute w-[400px] h-[400px] rounded-full bg-sky-500/5 blur-[120px] bottom-[10%] right-[10%] pointer-events-none" />
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 shadow-2xl relative z-10 border border-white/10">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-sky-400 to-purple-600 flex items-center justify-center font-black text-white text-3xl tracking-widest mx-auto mb-4 shadow-[0_0_20px_rgba(168,85,247,0.4)]">
            V
          </div>
          ...
          <p className="text-sm text-gray-400 mt-2">Sign up for secure document intelligence</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full btn-premium py-3.5 text-white disabled:opacity-50 select-none mt-5"
          >
            {loading ? (
